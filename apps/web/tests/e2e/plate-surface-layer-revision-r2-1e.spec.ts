...
test.beforeEach(() => {
  test.skip(
    true,
    "CUTOVER-WEB-LONG: progressive Plate revision coverage is retained in ReaderRecordPlateSurface Vitest; this legacy harness suite awaits Physical deletion.",
  );
});
