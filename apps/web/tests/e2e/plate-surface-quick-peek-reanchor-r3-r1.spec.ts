...
test.beforeEach(() => {
  test.skip(
    true,
    "CUTOVER-WEB-LONG: Quick Peek coverage is retained in ReaderRecordPlateSurface Vitest and final Reader smoke; this legacy harness suite awaits Physical deletion.",
  );
});
