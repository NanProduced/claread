...
/**
 * Monochrome Google mark, taken from the Efferd `google-icon` registry item
 * (https://efferd.com/r/new-york/google-icon.json). Renders in currentColor so
 * it follows the surrounding button's text color.
 */
