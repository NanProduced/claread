 ...
 *
 * 聚合：
 * - markdown-kit: callout children 的 markdown deserialize 后渲染
 * - reader-blocks-kit: reader_paragraph / reader_blockquote / reader_callout / reader_sentence_analysis element plugin
 * - reader-leaf-kit: vocabulary / grammar / user_highlight / user_note leaf plugin
 * - floating-toolbar-kit: Plate FloatingToolbar plugin，只读模式下选区浮动工具栏
 * - comment-kit: Plate CommentPlugin + CommentLeaf，inline comment mark 渲染
