...
export const ConversationContent = ({
  ...
  <StickToBottom.Content
    className={cn("flex min-h-full flex-col gap-7 px-1 py-3 sm:gap-8 sm:px-2 sm:py-4", className)}
    scrollClassName={cn("min-h-0 overflow-y-auto overscroll-contain", scrollClassName)}
    {...props}
  />
);
