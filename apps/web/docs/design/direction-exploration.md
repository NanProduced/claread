...
> **状态**: `REFERENCE` | **最后更新**: 2026-05-18
> 本文保留 Claread Web 第一版页面形态探索时形成的上游判断，主要服务于页面结构和产品气质回溯。
> 稳定结论已经吸收到 `apps/web/DESIGN.md`、`component-library-v0.md`、`component-system.md` 和 `reader-ia.md`。本文不再作为当前组件库规范或页面实现的直接真相源。
...
PNG 方向图、组件预览和浏览器截图只作为本地评审参考，不作为长期事实来源。`apps/web/docs/design/**/*.png` 已加入 `.gitignore`；稳定结论应沉淀到 `component-library-v0.md`、`component-system.md`、`reader-ia.md`、`PRODUCT.md` 和 `DESIGN.md`。

本文保留的稳定方向包括：报纸头版 Start/Login、公开每日精读、光圈 rail、中心原文画布、画布左侧词典详情卡片、短时上下文操作浮层、画布右侧 AI 工作区、lens-blue focus pin、语义标注和纸质 note slip。
