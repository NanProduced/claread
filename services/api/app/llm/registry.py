...
def _build_model_registry_cached(
    *,
    ...
    settings = Settings(
        ...
        reader_semantic_outline_model_profile=reader_semantic_outline_model_profile,
        ...
        daily_translation_model_profile=daily_translation_model_profile,
        daily_analysis_model_profile=daily_analysis_model_profile,
        daily_takeaways_model_profile=daily_takeaways_model_profile,
    ...
    route_defaults = {
        ...
        for route, profile_name in {
            ...
            MODEL_ROUTE_READER_LAYER_SEMANTIC_OUTLINE: (
                settings.reader_semantic_outline_model_profile
            ),
            ...
            MODEL_ROUTE_DAILY_TRANSLATION: settings.daily_translation_model_profile,
            MODEL_ROUTE_DAILY_ANALYSIS: settings.daily_analysis_model_profile,
            MODEL_ROUTE_DAILY_TAKEAWAYS: settings.daily_takeaways_model_profile,
...
def build_model_registry(settings: Settings) -> ModelRegistry:
    return _build_model_registry_cached(
        ...
        daily_translation_model_profile=settings.daily_translation_model_profile,
        daily_analysis_model_profile=settings.daily_analysis_model_profile,
        daily_takeaways_model_profile=settings.daily_takeaways_model_profile,
